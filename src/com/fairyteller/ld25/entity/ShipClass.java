...
public class ShipClass implements EntityClass {
    ...
    public ShipClass(ColorRGBA color, int baseDamage, int baseHealth) {
        this(null, null, color, baseDamage, baseHealth);
        this.color = color;
    }

    public ShipClass(Material material, Geometry geometry, ColorRGBA color, int baseDamage, int baseHealth) {
